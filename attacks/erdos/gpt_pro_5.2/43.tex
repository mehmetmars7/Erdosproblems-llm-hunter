% Solutions/notes for Erd\H{o}s Problems #43, #44, #50, #51, #52
% Source problems file: 43-52.tex
%
% Conventions used below:
% - [N] := {1,2,...,N}.
% - A Sidon set in \mathbb{Z} means a finite set A such that
%   a_1+a_2=a_3+a_4 with a_i\in A implies {a_1,a_2}={a_3,a_4} as multisets.
%   Equivalently, all differences a-b with a\neq b are distinct.
